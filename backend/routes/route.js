...
const router = Router();
const imgURL = new Array(20)
  .fill(0)
  .map(
    (_, i) => `https://mdbootstrap.com/img/Photos/Slides/img%20(${i + 115}).jpg`
  );
    ...
    displayList: [
      {
        ...
        description:
          'This is a responsive box.When your screen size is small enough, the text will be arranged below the picture.',
      ...
      },
      {
        ...
        description:
          'When your screen size is large enough, the text will be arranged on the right side of the picture.',
      ...
      },
      {
        ...
        description:
          'On the mobile phone, if you click this box, it will become larger.On the PC side, when your mouse hovers over the box, so will it.',
...
router.get('/getWaterfall', (req, res) => {
  ...
  const imgs = new Array(20)
    ...
    .map(
      (_, i) =>
        `https://www.photock.jp/photo/middle/photo0000-${
          i + 5555 + n * 20 + category * 60
        }.jpg`
    );
  console.log(n);
  res.send({
